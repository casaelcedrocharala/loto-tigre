...
function renderizarProductos(lista) {
    const grid = document.getElementById('grid-abrigos'); // Apunta al contenedor de abrigos
    if (!grid) return;
...
document.addEventListener('DOMContentLoaded', cargarAbrigos);
